...
export function Header() {
  ...
  const handleSearch = (e: React.FormEvent) => {
    ...
    if (query.toUpperCase().startsWith("AMU-") || query.toUpperCase().startsWith("PK-")) {
      navigate(`/dashboard?track=${query}`);
    } else {
      ...
      <div className="container mx-auto px-4 h-16 sm:h-20 flex items-center justify-between gap-4 lg:gap-8">
        <Link to="/" className="flex items-center gap-2 group shrink-0">
          ...
          <span className="text-xl font-bold tracking-tight text-slate-900 hidden sm:block">
            AMU <span className="text-blue-600">Courier</span>
          </span>
        </Link>
        ...
        <div className="flex-1 max-w-xl hidden md:block">
          <form onSubmit={handleSearch} className="relative group">
            ...
            <input 
              ...
              placeholder="Search products, stores, or tracking numbers (e.g., AMU-10582)..." 
